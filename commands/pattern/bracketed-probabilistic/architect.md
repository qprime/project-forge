...
Fills placeholders in `commands/global/architect.md` for projects declaring the Bracketed-probabilistic pattern. Sections below name the placeholder they fill.
