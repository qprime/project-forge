...
Fills placeholders in `commands/global/architect.md` for projects declaring the Declare-and-satisfy pattern. Sections below name the placeholder they fill.
