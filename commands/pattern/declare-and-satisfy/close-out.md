...
# Declare-and-satisfy pattern — close-out contribution

Fills placeholders in `commands/global/close-out.md` for projects declaring the Declare-and-satisfy pattern.
